...
<template>
	<div id="container" class="container">
		<div class="row">
			<legend>
				<h2><span class="mega-octicon octicon-mark-github"></span> GitHub文件浏览器</h2></legend>
			<form id="changeRepoForm" @submit.prevent="changeRepo()" class="form-inline">
				<div class="form-group">
					<label for="fullRepoName">Full Repo Name：</label>
					<input type="text" id="fullRepoName" class="form-control" placeholder="vuejs/vue" v-model="fullRepoName" style="width: 300px;">
				</div>
